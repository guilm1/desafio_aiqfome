...
final class AddFavoritoDoc
{
    /**
     * @OA\Post(
     *   path="/api/favorito/add/{uuid}",
     *   operationId="favoritoAdd",
     *   tags={"Favorito"},
     *   summary="Adicionar produto aos favoritos do cliente",
     *   description="Adiciona um produto à lista de favoritos do cliente identificado por UUID.",
     *   security={{"bearerAuth":{}}},
     *
     *   @OA\Parameter(
     *     name="X-API-KEY",
     ...
     *   @OA\RequestBody(
     *     required=true,
     *     description="Dados para adicionar favorito",
     *     @OA\JsonContent(
     *       required={"produto_id"},
     *       oneOf={
     *         @OA\Schema(
     *           type="object",
     *           @OA\Property(property="produto_id", type="string", example="15", description="ID do produto (string ou número)")
     *         ),
     *         @OA\Schema(
     *           type="object",
     *           @OA\Property(property="produto_id", type="integer", example=15, description="ID do produto (string ou número)")
     *         )
     *       }
     *     )
     *   ),
     ...
     *         @OA\Property(property="produto_id", oneOf={
     *           @OA\Schema(type="string", example="10"),
     *           @OA\Schema(type="integer", example=10)
     *         }),
     *         @OA\Property(property="title", type="string", example="SanDisk SSD PLUS 1TB Internal SSD - SATA III 6 Gb/s"),
     *         @OA\Property(property="image", type="string", format="uri", example="https://fakestoreapi.com/img/61U7T1koQqL._AC_SX679_t.png"),
     *         @OA\Property(property="price", type="number", format="float", example=109),
     *         @OA\Property(
     *           property="review",
     *           type="object",
     *           required={"rate","count"},
     *           @OA\Property(property="rate", type="number", format="float", example=2.9),
     *           @OA\Property(property="count", type="integer", example=470)
     *         )
     *       ),
     ...
     *           @OA\Property(property="success", type="boolean", example=false),
     *           @OA\Property(property="message", type="string", example="Produto já está listado nos favoritos do cliente.")
     *         ),
     *         @OA\Schema(
     *           type="object",
     *           required={"data","success","message"},
